...
sentimento_df = pd.read_csv("./data/reviews.csv")
...
frases_avaliacao = ["Fui muito bem atendido", "Tive pessima experiencia na loja", "Gostei da rapidez da entrega","Eu não gostei de nada disso", "Estava excelente, principalmente o hamburguer", "Nem tão bom, nem tão ruim"]
